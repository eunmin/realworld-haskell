...
/* package quickcheck-string-random-0.1.4.4 */
#ifndef VERSION_quickcheck_string_random
#define VERSION_quickcheck_string_random "0.1.4.4"
#endif /* VERSION_quickcheck_string_random */
#ifndef MIN_VERSION_quickcheck_string_random
#define MIN_VERSION_quickcheck_string_random(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 4)
#endif /* MIN_VERSION_quickcheck_string_random */
/* package realworld-haskell-0.1.0.0 */
#ifndef VERSION_realworld_haskell
#define VERSION_realworld_haskell "0.1.0.0"
#endif /* VERSION_realworld_haskell */
...
#define CURRENT_COMPONENT_ID "realworld-haskell-0.1.0.0-J8ZEIlx4qQx3WMTprdeotW-realworld-haskell-test"
